  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const { error: insertError } = await supabase.from('candidaturas').insert({
        ...
        // candidatura espontânea já entra direto no banco de talentos,
        // já que não existe processo seletivo aberto para ela ainda
        banco_talentos: espontanea,
      })
        ...
        {enviado ? (
          <div className="p-8 text-center">
            ...
            <p className="text-slate-500 text-sm mb-6">
              {espontanea
                ? 'Recebemos seu currículo e ele já está no nosso banco de talentos. Quando abrir uma vaga compatível, você será considerado.'
